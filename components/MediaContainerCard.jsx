  ...
  return (
    <div class="min-h-96 flex flex-wrap overflow-hidden">
      ...
      <div class="w-full overflow-hidden md:w-1/2 px-12">
        <div class="mb-8">
          ...
          <p class="text-gray-700 text-custom-color-2  text-xl font-bold pb-12">
            ...
            business to business events with an end to end understanding of the
            event life cycle from research through to planning, speaker
            ...
            organisations such as IBM, Adobe, BP, Deloitte, Pinsent Masons, PwC,
            GSK, Accenture, EY, Hilton, Bloomberg, Barclays, Tesco, BT, NHS and
            Network Rail to name a few: for over 250 face to face and online
            conferences, workshops and in-house training sessions.
          </p>
          <p class="text-gray-700 text-custom-color-2  text-xl font-bold pb-12">
            A problem: during the Pandemic, as the world was thrust online, a
            disparity grew and is still growing, between those who are quick to
            adapt their approach to delivering online training and
            presentations, and those who are not. In-person meetings, teachings,
            presentations and events are not the same as online.
          </p>
        </div>
      </div>
      {/* Image */}
      <div class="w-full overflow-hidden md:w-1/2 ">
        <img
          className="w-full"
          src="/static/images/KatieAlmostWithLogo.png"
          alt=""
        />
      </div>
    </div>
