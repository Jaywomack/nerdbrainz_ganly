const SkillTags = () => {
  return (
    <div className="flex flex-wrap -mx-3 overflow-hidden lg:-mx-4 py-24 text-center bg-custom-color-2">
      <div className="my-3 px-3 w-full overflow-hidden md:w-1/3 lg:my-4 lg:px-4 lg:w-1/3">
        <h3 className="ml-3 text-4xl text-custom-color-3 border-b-2 border-custom-color-3">
          Teach
        </h3>
      ...
      <div className="my-3 px-3 w-full overflow-hidden md:w-1/3 lg:my-4 lg:px-4 lg:w-1/3">
        <h3 className="text-4xl text-custom-color-3 border-b-2 border-custom-color-3">
          Train
        </h3>
        <p className="w-8/12 mx-auto my-8 text-xl text-white">
      ...
      <div className="my-3 px-3 w-full overflow-hidden md:w-1/3 lg:my-4 lg:px-4 lg:w-1/3">
        <h3 className=" mr-3 text-4xl text-custom-color-3 border-b-2 border-custom-color-3">
          Technology
        </h3>
        <p className="w-8/12 mx-auto my-8 text-xl text-white">
