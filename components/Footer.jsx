...
const Footer = () => {
  return (
    <footer className="flex justify-center  text-white bg-custom-color-3 w-full">
      <div className="w-full pt-6">
        ...
        <div className="flex items-center justify-center text-white bg-custom-color-3 text-white  w-full">
          <a
